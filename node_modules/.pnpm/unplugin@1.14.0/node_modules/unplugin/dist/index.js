...
// src/rspack/index.ts
var TRANSFORM_LOADER = (0, import_path8.resolve)(
  __dirname,
  false ? "../../dist/rspack/loaders/transform.js" : "rspack/loaders/transform"
);
var LOAD_LOADER = (0, import_path8.resolve)(
  __dirname,
  false ? "../../dist/rspack/loaders/load.js" : "rspack/loaders/load"
);
var VIRTUAL_MODULE_PATH = (0, import_path8.resolve)(__dirname, false ? "../../dist/rspack/virtual.js" : "rspack/virtual.js");
var VIRTUAL_MODULE_QUERY_PREFIX = "?unplugin_rspack_virtual=";
var VIRTUAL_MODULE_PREFIX = VIRTUAL_MODULE_PATH + VIRTUAL_MODULE_QUERY_PREFIX;
...
function createBuildContext3(options, compiler, compilation, loaderContext) {
  ...
  return {
    ...
    addWatchFile(id) {
      options.addWatchFile((0, import_path9.resolve)(import_process.default.cwd(), id));
    },
    emitFile(emittedFile) {
      const outFileName = emittedFile.fileName || emittedFile.name;
      if (emittedFile.source && outFileName) {
...
// src/webpack/index.ts
var TRANSFORM_LOADER2 = (0, import_path10.resolve)(
  __dirname,
  false ? "../../dist/webpack/loaders/transform" : "webpack/loaders/transform"
);
var LOAD_LOADER2 = (0, import_path10.resolve)(
  __dirname,
...
function getWebpackPlugin(factory) {
  return (userOptions) => {
    return {
      apply(compiler) {
        const VIRTUAL_MODULE_PREFIX2 = (0, import_path10.resolve)(compiler.options.context ?? import_process2.default.cwd(), "_virtual_");
        const injected = compiler.$unpluginContext || {};
        compiler.$unpluginContext = injected;
        const meta = {
          framework: "webpack",
