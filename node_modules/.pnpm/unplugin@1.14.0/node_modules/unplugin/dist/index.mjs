...
var VIRTUAL_MODULE_PATH = resolve4(__dirname, false ? "../../dist/rspack/virtual.js" : "rspack/virtual.js");
...
function createBuildContext3(options, compiler, compilation, loaderContext) {
  ...
  return {
    ...
    addWatchFile(id) {
      options.addWatchFile(resolve5(process2.cwd(), id));
    },
    emitFile(emittedFile) {
      const outFileName = emittedFile.fileName || emittedFile.name;
      if (emittedFile.source && outFileName) {
...
function getWebpackPlugin(factory) {
  return (userOptions) => {
    return {
      apply(compiler) {
        const VIRTUAL_MODULE_PREFIX2 = resolve6(compiler.options.context ?? process3.cwd(), "_virtual_");
        const injected = compiler.$unpluginContext || {};
        compiler.$unpluginContext = injected;
        const meta = {
          framework: "webpack",
